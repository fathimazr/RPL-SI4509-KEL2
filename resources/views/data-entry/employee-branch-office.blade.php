    ...
    <div class="main">
        ...
        <form id="form" action="{{ route('branch-office.store') }}" method="POST">
                ...
                <div class="form-group">
                        ...
                        <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" id="branch_office" name="branch_office" type="text" placeholder="Please fill with your trafo's new registered brand">
                    </div>
                <div class="row">
