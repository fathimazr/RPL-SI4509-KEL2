<div class="w-full h-[110px] flex items-center border-b-2 border-b-gray-200 justify-between px-6 pr-10 bg-white">
    ...
    <div id="notificationPopup" class="hidden absolute top-[65px] left-4 bg-white border border-gray-300 shadow-md rounded-md w-80">
        ...
        <div class="p-4">
            <div class="items-center mb-2 px-4 py-2" style="background:#F6F6F6">
                <h1 class="font-bold" style= "color:black; font-size: 16px">Trafo ID 1110 </h1>
                <div class = "flex" style = "color:#7F7F7F; font-size: 16px">
                    <p>There is an error on your transformator</p>
                    <p>01/02</p>
                </div>
            </div>
            <div class="items-center mb-2 px-4 py-2" style="background:#FFFFFF">
                <h1 class="font-bold" style= "color:black; font-size: 16px">Trafo ID 1111 </h1>
                <div class = "flex" style = "color:#7F7F7F; font-size: 16px">
