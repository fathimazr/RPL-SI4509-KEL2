<div class="flex">
    <aside class=" w-[250px] h-full overflow-y-auto bg-[#12A2BD] md:block flex-shrink-0 border" aria-label="Sidebar">
        <div class="max-h-screen flex flex-col gap-5 p-5 overflow-y-auto rounded-xl ">
            ...
            <div class="">
                <form method="POST" action="{{ route('logout') }}" class="w-full flex bg-gradient-to-r from-cyan-500 to-blue-500 ... items-center px-2 text-gray-900 rounded-full dark:text-white hover:bg-[#15677B] dark:hover:bg-gray-700 group">
                    @csrf
