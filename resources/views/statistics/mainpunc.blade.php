<x-app-layout>
        ...
        <div class="flex justify-between mx-10 gap-7">
            ...
            <div class="w-full p-10 bg-gradient-to-r from-cyan-500 to-blue-500 items-center rounded-3xl shadow-lg shadow-blue-400 flex justify-between">
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <h1 class="text-[50px] font-bold tracking-tight text-white">{{ $alertingCount }}</h1>
                </div>
            ...
            <div class="w-full p-10 bg-gradient-to-r from-cyan-500 to-blue-500 items-center rounded-3xl shadow-lg shadow-blue-400 flex justify-between">
                ...
                <div class="flex flex-col gap-5">
                    ...
                    <h1 class="text-[50px] font-bold tracking-tight text-white">{{ $maintenanceCount }}</h1>
                </div>
                ...
                <div class=" bg-gradient-to-b from-[#39e1ff] to-white rounded-xl shadow-lg shadow-cyan-100 p-10 pb-4">
                    <div class="flex justify-between pb-4 mb-4 items-center">
                        <div class="flex items-center pt-2">
                            <h1 class="leading-none text-2xl font-extrabold">Maintenance <br> Punctuality Growth</h1>
                        </div>
                        <div class="flex gap-3">
                            ...
                            <button id="weekly-button" class="bg-[#12A2BD] hover:bg-[#15677B] text-white font-bold py-1 px-3 rounded-full text-center">
                                Weekly
                            </button>
                        </div>    
                    </div>
    ...
    <script>
        // Data untuk Monthly
        const monthlyData = <?php echo json_encode($monthlyDataMainPunc); ?>;
        // const monthlyData = [
        //     { x: "Jan", y: 131 },
        //     { x: "Feb", y: 322 },
        //     { x: "Mar", y: 63 },
        ...
        // Data untuk Weekly
        const weeklyData = <?php echo json_encode($weeklyDataMainPunc); ?>;
        // const weeklyData = [
        //     { x: "Week 1", y: 30 },
        //     { x: "Week 2", y: 40 },
        //     { x: "Week 3", y: 35 },
